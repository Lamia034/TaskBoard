...
<form method="POST" id="task-form">
  ...
  <div id="task-container">
    <div class="task">
      ...
      <br>
      <label>
        <input type="radio" name="TaskStatus[0][]" value="ToDo"> To do
      </label>
      <label>
        <input type="radio" name="TaskStatus[0][]" value="Doing"> Doing
      </label>
      <label>
        <input type="radio" name="TaskStatus[0][]" value="Done"> Done
      </label>
      <br>
  ...
  <br>
  <br>
  <button type="submit" name="add" value="add">GO</button>
</form>
...
<form method="POST" id="task-form">
  ...
  <label for="TaskName" >Task Name:<br>
    <input type="text" name="TaskName[]"  placeholder="Task">  <br>
</label>
    <label for="TaskStatus" >Task Status:<br>
 
      <input class="mr-2 leading-tight" name="TaskStatus[i][]" type="radio" value="ToDo">
      <span class="text-sm">
        To do
      </span>
    </label>
    <label >
      <input class="mr-2 leading-tight" name="TaskStatus[i][]" type="radio" value="Doing">
      <span class="text-sm">
        Doing
      </span>
    </label>
    <label >
      <input class="mr-2 leading-tight" name="TaskStatus[i][]" type="radio" value="Done">
      <span class="text-sm">
        Done
      </span>
    </label> 
    ...
    <br>
    <button type="button" id="add-other-task-button">Add Other Task</button><br>
    <div id="add-other-task"></div>
      <button type="submit"  name="add" value="add">GO</button>
